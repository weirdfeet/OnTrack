...
/**
 * This is the item provider adapter for a {@link uk.ac.swanseacoventry.cmt.ontrack.Terminal} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Terminal_connector_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Terminal_connector_feature", "_UI_Terminal_type"),
				 OntrackPackage.Literals.TERMINAL__CONNECTOR,
				 true,
				 false,
				 true,
				 null,
