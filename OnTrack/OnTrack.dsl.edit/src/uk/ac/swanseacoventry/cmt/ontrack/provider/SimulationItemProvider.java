...
/**
 * This is the item provider adapter for a {@link uk.ac.swanseacoventry.cmt.ontrack.Simulation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SimulationItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addSubTrackPlanPropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OntrackPackage.Literals.SIMULATION__NAME,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Sub Track Plan feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addSubTrackPlanPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Simulation_subTrackPlan_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Simulation_subTrackPlan_feature", "_UI_Simulation_type"),
				 OntrackPackage.Literals.SIMULATION__SUB_TRACK_PLAN,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(OntrackPackage.Literals.SIMULATION__STEPS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(OntrackPackage.Literals.SIMULATION__STEPS,
				 OntrackFactory.eINSTANCE.createSimulationAction()));
	}
