...
/**
 * This is the item provider adapter for a {@link uk.ac.swanseacoventry.cmt.ontrack.Signal} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OntrackPackage.Literals.SIGNAL__NAME,
				 true,
				 false,
				 false,
	...
	protected void addTrackPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Signal_track_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Signal_track_feature", "_UI_Signal_type"),
				 OntrackPackage.Literals.SIGNAL__TRACK,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addConnectorPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Signal_connector_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Signal_connector_feature", "_UI_Signal_type"),
				 OntrackPackage.Literals.SIGNAL__CONNECTOR,
				 true,
				 false,
				 true,
				 null,
