...
/**
 * This is the item provider adapter for a {@link uk.ac.swanseacoventry.cmt.ontrack.Exit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Exit_connector_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Exit_connector_feature", "_UI_Exit_type"),
				 OntrackPackage.Literals.EXIT__CONNECTOR,
				 true,
				 false,
				 true,
				 null,
