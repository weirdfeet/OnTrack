 ...
 * @generated
 */
public class TerminalItemSemanticEditPolicy extends OntrackBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public TerminalItemSemanticEditPolicy() {
		super(OntrackElementTypes.Terminal_2005);
	}
	...
	*/
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (OntrackVisualIDRegistry.getVisualID(outgoingLink) == TerminalConnectorEditPart.VISUAL_ID) {
