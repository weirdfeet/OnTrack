 ...
 * @generated
 */
public class TrackNameEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				OntrackVisualIDRegistry
						.getType(uk.ac.swanseacoventry.cmt.ontrack.diagram.edit.parts.TrackNameEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = OntrackParserProvider.getParser(OntrackElementTypes.Track_4005, getParserElement(),
					OntrackVisualIDRegistry
							.getType(uk.ac.swanseacoventry.cmt.ontrack.diagram.edit.parts.TrackNameEditPart.VISUAL_ID));
		}
		return parser;
