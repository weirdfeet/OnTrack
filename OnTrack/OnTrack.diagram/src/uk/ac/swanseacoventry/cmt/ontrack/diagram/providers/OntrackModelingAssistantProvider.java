 ...
 * @generated
 */
public class OntrackModelingAssistantProvider extends ModelingAssistantProvider {
	...
	*/
	protected EObject selectElement(EObject[] elements) {
		...
		dialog.setMessage(Messages.OntrackModelingAssistantProviderMessage);
		dialog.setTitle(Messages.OntrackModelingAssistantProviderTitle);
