 ...
 * @generated
 */
public class PointNameEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				OntrackVisualIDRegistry
						.getType(uk.ac.swanseacoventry.cmt.ontrack.diagram.edit.parts.PointNameEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = OntrackParserProvider.getParser(OntrackElementTypes.Point_4001, getParserElement(),
					OntrackVisualIDRegistry
							.getType(uk.ac.swanseacoventry.cmt.ontrack.diagram.edit.parts.PointNameEditPart.VISUAL_ID));
		}
		return parser;
