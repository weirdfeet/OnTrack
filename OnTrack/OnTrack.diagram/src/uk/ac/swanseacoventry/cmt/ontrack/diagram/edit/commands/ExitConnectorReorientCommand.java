 ...
 * @generated
 */
public class ExitConnectorReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public ExitConnectorReorientCommand(ReorientReferenceRelationshipRequest request) {
	...
	*/
	public boolean canExecute() {
		if (false == referenceOwner instanceof Exit) {
			return false;
		}
	...
	*/
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof Connector && newEnd instanceof Exit)) {
			return false;
		}
		return OntrackBaseItemSemanticEditPolicy.getLinkConstraints().canExistExitConnector_4007(getNewSource(),
				getOldTarget());
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		return OntrackBaseItemSemanticEditPolicy.getLinkConstraints().canExistExitConnector_4007(getOldSource(),
				getNewTarget());
	}
	...
	* @generated
	*/
	protected Exit getOldSource() {
		return (Exit) referenceOwner;
	}

	/**
	* @generated
	*/
	protected Exit getNewSource() {
		return (Exit) newEnd;
	}
