...
public class MCPaths
	...
	public MCPaths() {
		super(GRID);
		setPreferenceStore(OntrackDiagramEditorPlugin.getInstance().getPreferenceStore());
		setDescription("Paths to Model Checkers");
	}
	...
	public void createFieldEditors() {
		addField(new FileFieldEditor(PreferenceConstants.FDR3_PATH, 
