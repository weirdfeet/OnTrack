...
import uk.ac.swanseacoventry.cmt.ontrack.diagram.edit.policies.OntrackTextSelectionEditPolicy;
 ...
 * @generated
 */
public class SignalNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				OntrackVisualIDRegistry
						.getType(uk.ac.swanseacoventry.cmt.ontrack.diagram.edit.parts.SignalNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new OntrackTextSelectionEditPolicy());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = OntrackParserProvider.getParser(OntrackElementTypes.Signal_2002, getParserElement(),
					OntrackVisualIDRegistry.getType(
							uk.ac.swanseacoventry.cmt.ontrack.diagram.edit.parts.SignalNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null, OntrackEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new SignalNameFigure();
	}

	/**
	* @generated
	*/
	public class SignalNameFigure extends WrappingLabel {
