 ...
 * @generated
 */
public class EntranceItemSemanticEditPolicy extends OntrackBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public EntranceItemSemanticEditPolicy() {
		super(OntrackElementTypes.Entrance_2003);
	}
	...
	*/
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (OntrackVisualIDRegistry.getVisualID(outgoingLink) == EntranceConnectorEditPart.VISUAL_ID) {
