...
public class ConnectorUpdateLocationCommand extends AbstractTransactionalCommand {
	...
	public ConnectorUpdateLocationCommand(IGraphicalEditPart ep, int ix, int iy, boolean itranslated) {
