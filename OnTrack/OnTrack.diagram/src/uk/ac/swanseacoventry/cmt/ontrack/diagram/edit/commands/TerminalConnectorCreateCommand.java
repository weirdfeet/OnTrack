 ...
 * @generated
 */
public class TerminalConnectorCreateCommand extends EditElementCommand {
	...
	* @generated
	*/
	public TerminalConnectorCreateCommand(CreateRelationshipRequest request, EObject source, EObject target) {
	...
	*/
	public boolean canExecute() {
		...
		return OntrackBaseItemSemanticEditPolicy.getLinkConstraints().canCreateTerminalConnector_4008(getSource(),
				getTarget());
	}
