...
public class TrackPlanCoveringCollapseCommand extends AbstractTransactionalCommand {
	
	private DiagramEditPart trackplanEP;
	private TrackPlan trackplan;
	
	public TrackPlanCoveringCollapseCommand(IGraphicalEditPart ep) {
