 ...
 * @generated
 */
public class ConnectorIdEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	static {
		registerSnapBackPosition(
				OntrackVisualIDRegistry
						.getType(uk.ac.swanseacoventry.cmt.ontrack.diagram.edit.parts.ConnectorIdEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = OntrackParserProvider.getParser(OntrackElementTypes.Connector_2001, getParserElement(),
					OntrackVisualIDRegistry.getType(
							uk.ac.swanseacoventry.cmt.ontrack.diagram.edit.parts.ConnectorIdEditPart.VISUAL_ID));
		}
		return parser;
	}
