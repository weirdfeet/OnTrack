 ...
 * @generated
 */
public class ExitItemSemanticEditPolicy extends OntrackBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public ExitItemSemanticEditPolicy() {
		super(OntrackElementTypes.Exit_2004);
	}
	...
	*/
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (OntrackVisualIDRegistry.getVisualID(outgoingLink) == ExitConnectorEditPart.VISUAL_ID) {
