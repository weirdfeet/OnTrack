 ...
 * @generated
 */
public class SignalConnectorReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public SignalConnectorReorientCommand(ReorientReferenceRelationshipRequest request) {
	...
	*/
	protected boolean canReorientSource() {
		...
		return OntrackBaseItemSemanticEditPolicy.getLinkConstraints().canExistSignalConnector_4004(getNewSource(),
				getOldTarget());
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		return OntrackBaseItemSemanticEditPolicy.getLinkConstraints().canExistSignalConnector_4004(getOldSource(),
				getNewTarget());
	}
